...
if(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86" OR CMAKE_SYSTEM_PROCESSOR MATCHES "i[3-6]86")
	set(EMBED_TEST_PROCESSOR "x86"     CACHE STRING "System processor (e.g., x86, armv6m)")
elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64")
	set(EMBED_TEST_PROCESSOR "x86_64"  CACHE STRING "System processor (e.g., x86, armv6m)")
elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "arm" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "cortex-m0plus")
	set(EMBED_TEST_PROCESSOR "armv6m"  CACHE STRING "System processor (e.g., x86, armv6m)")
elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "cortex-m33")
	set(EMBED_TEST_PROCESSOR "armv8m"  CACHE STRING "System processor (e.g., x86, armv6m)")
elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64")
	set(EMBED_TEST_PROCESSOR "aarch64" CACHE STRING "System processor (e.g., x86, armv6m)")
else()
